...
public class Grid extends JPanel {
	...
	protected Color[][] colors, newColors;
	...
	// makes frame visible and makes setting
	...
	// returns true if the row and col is in bounds
	...
	// brings next step of game forward
